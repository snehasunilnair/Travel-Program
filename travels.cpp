...
float tour::Total_Charge()
{
 float roomcost,foodcost,tripcost,travelcost,profit=10000,cost=0,total=0;
  ...
  switch(destination)
  {
   case 1:
   case 2:
   case 3:tripcost=50000;
          break;
   case 4:
   case 5:
   case 6:
   case 7:tripcost=20000;
          break;
   case 8:
   case 9:
   case 10:tripcost=30000;
           break;
  }
  switch(mode_of_travel)
  {
   case 1:travelcost=days*5000;
          break;
   case 2:travelcost=days*3000;
          break;
   case 3:travelcost=days*2000;
  }
  ...
  for(int i=0;i<no_of_passengers;i++)
  {
   ...
   switch(food_type[i])
   {
    case 1:foodcost=days*2000;
    case 2:foodcost=days*3000;
    case 3:foodcost=days*5000;
   }
   cost+=foodcost;
   cost+=profit;
   if(ages[i]<12)
 ...
 switch(hotelrating)
 {
  case 1:roomcost=5000;
         break;
  case 2:roomcost=7500;
         break;
  case 3:roomcost=12000;
         break;
  case 4:roomcost=15000;
         break;
  case 5:roomcost=20000;
         break;
 }
...
void main()
{
 ...
 do
 {
  ...
  switch(ch)
  {
   case 1:file.open("tourism.dat",ios::binary|ios::out);
          t.Booking();
   ...
   case 4:flag=0;
          ...
          cin>>tid;
	       afile.open("tourism.dat",ios::in|ios::binary);
	       ofile.open("tmptk.dat",ios::out|ios::binary);
				while(afile)
				{
					afile.read((char *)&t,sizeof(t));
					if (tid==t.getpid())
					{
						flag=1;
					}
				...
				afile.open("tmptk.dat",ios::in|ios::binary);
				ofile.open("tourism.dat",ios::out|ios::binary);
				while(afile)
				{
					afile.read((char *)&t,sizeof(t));
					ofile.write((char *)&t,sizeof(t));
